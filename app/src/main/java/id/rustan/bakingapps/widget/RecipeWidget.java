...
public class RecipeWidget extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            widgetInteractor.getRecipe()
                    .subscribe(recipe -> {
                                Intent intent = new Intent(context, ServiceRecipeWidget.class);
                                ...
                                remoteViews.setOnClickPendingIntent(R.id.next_button, nextButIntent);

                                PendingIntent prevButIntent = getPendingSelfIntent(context, PREV_RECIPE_ACTION);
                                remoteViews.setOnClickPendingIntent(R.id.previous_button, prevButIntent);

                                remoteViews.setRemoteAdapter(R.id.ingredient_list, intent);
                                remoteViews.setEmptyView(R.id.ingredient_list, R.id.empty_view);
    ...
    private void injectDependencies(Context context){
        BakingApps app = (BakingApps) context.getApplicationContext();
